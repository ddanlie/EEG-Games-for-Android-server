...
bids_root: PathLike | None = "./test_data2"
# """
...
process_empty_room: bool = True # (its MRI i dont use it)
# """
...
ch_types: Annotated[Sequence[Literal["meg", "mag", "grad", "eeg"]], Len(1, 4)] = ["eeg"]
# """
...
data_type: Literal["meg", "eeg"] | None = "eeg"
# """
# The BIDS data type.
...
eog_channels: Sequence[str] | None = ['Fp1', 'Fp2'] 
# """
...
eeg_template_montage: str | DigMontageType | None = "standard_1020"
# """
...
reader_extra_params: dict = {"units": "uV"}
# """
...
notch_freq: float | Sequence[float] | None = [25, 50, 100, 150]
# """
...
epochs_metadata_tmin: float | str | list[str] | None = -0.2
# """
...
epochs_metadata_tmax: float | str | list[str] | None = 1.0
# """
